...
// ============================================
// DAY 4 - LARAVEL INSTALLATION & FIRST PROGRAM
// ============================================
...
Route::get('/', function () {
    ...
    <body>
        <div class='card'>
            ...
            <div class='footer'>Laravel Framework • PHP &amp; Laravel Internship Program</div>
        </div>
    </body>
    </html>
    ";
...
Route::get('/welcome', function () {
    ...
    <head>
        ...
        <style>
            ...
            .time { color: rgba(255,255,255,0.5); margin-top: 10px; }
            a {
                display: inline-block;
                margin-top: 20px;
                color: #667eea;
...
Route::get('/add/{a}/{b}', function ($a, $b) {
    ...
    <head>
        ...
        <style>
            ...
            .calc { font-size: 2rem; color: rgba(255,255,255,0.7); }
            a {
                display: inline-block;
                margin-top: 20px;
                color: #667eea;
