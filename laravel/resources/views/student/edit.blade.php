        ...
        <div class="card-custom">
            <div class="text-center mb-4">
                <h1 class="page-title" style="font-size: 1.8rem;">
                    <i class="fas fa-edit" style="background: linear-gradient(135deg, #f093fb, #f5576c); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"></i>
                    Edit Student
                </h1>
                <p class="page-subtitle">Update the student details</p>
            </div>
